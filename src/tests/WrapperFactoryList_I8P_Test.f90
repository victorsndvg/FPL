...
integer(I8P)                            :: val0D = 9
integer(I8P)                            :: val1D(1) = 9
integer(I8P)                            :: val2D(1,1) = 9
integer(I8P)                            :: val3D(1,1,1) = 9
integer(I8P)                            :: val4D(1,1,1,1) = 9
integer(I8P)                            :: val5D(1,1,1,1,1) = 9
integer(I8P)                            :: val6D(1,1,1,1,1,1) = 9
integer(I8P)                            :: val7D(1,1,1,1,1,1,1) = 9
...
end program WrapperFactoryList_I8P_Test
