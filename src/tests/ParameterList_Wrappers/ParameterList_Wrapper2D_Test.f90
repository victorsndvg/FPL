...
write(unit=OUTPUT_UNIT, fmt='(A,2I4)') 'I1P Shape:',  shape
if(Parameters%GetShape(Key='I2P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,2I4)') 'I2P Shape:',  shape
if(Parameters%GetShape(Key='I4P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,2I4)') 'I4P Shape:',  shape
if(Parameters%GetShape(Key='I8P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,2I4)') 'I8P Shape:',  shape
if(Parameters%GetShape(Key='R4P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,2I4)') 'R4P Shape:',  shape
if(Parameters%GetShape(Key='R8P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,2I4)') 'r8P Shape:',  shape
