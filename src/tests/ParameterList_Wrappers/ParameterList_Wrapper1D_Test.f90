...
if(allocated(I1Parray))  deallocate(I1Parray);  allocate(I1Parray(1));  I1Parray  = 1
if(allocated(I2Parray))  deallocate(I2Parray);  allocate(I2Parray(2));  I2Parray  = 2
if(allocated(I4Parray))  deallocate(I4Parray);  allocate(I4Parray(3));  I4Parray  = 4
if(allocated(I8Parray))  deallocate(I8Parray);  allocate(I8Parray(4));  I8Parray  = 8
...
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'I1P Shape:',  shape
if(Parameters%GetShape(Key='I2P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'I2P Shape:',  shape
if(Parameters%GetShape(Key='I4P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'I4P Shape:',  shape
if(Parameters%GetShape(Key='I8P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'I8P Shape:',  shape
if(Parameters%GetShape(Key='R4P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'R4P Shape:',  shape
if(Parameters%GetShape(Key='R8P',  shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'r8P Shape:',  shape
if(Parameters%GetShape(Key='L',    shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'L Shape:',  shape
if(Parameters%GetShape(Key='DLCA', shape=shape) /= 0) stop -1
write(unit=OUTPUT_UNIT, fmt='(A,1I4)') 'DLCA Shape:',  shape
