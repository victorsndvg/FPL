...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper3D_I1P_Set
        procedure         ::                 DimensionsWrapper3D_I1P_Get
        generic,   public :: Set          => DimensionsWrapper3D_I1P_Set
        generic,   public :: Get          => DimensionsWrapper3D_I1P_Get
