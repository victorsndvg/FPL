...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper3D_I4P_Set
        procedure         ::                 DimensionsWrapper3D_I4P_Get
        generic,   public :: Set          => DimensionsWrapper3D_I4P_Set
        generic,   public :: Get          => DimensionsWrapper3D_I4P_Get
