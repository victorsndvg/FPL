...
private
    ...
    private
        ...
        procedure, public :: toString       => DimensionsWrapper3D_I2P_toString
...
contains
    ...
    function DimensionsWrapper3D_I2P_toString(this) result(String) 
    !-----------------------------------------------------------------
        ...
        if(allocated(this%Value)) then
            do idx3=1, size(this%Value,3)
                do idx2=1, size(this%Value,2)
                    String = String // trim(str(n=this%Value(:,idx2,idx3))) // ','
                enddo
            enddo
