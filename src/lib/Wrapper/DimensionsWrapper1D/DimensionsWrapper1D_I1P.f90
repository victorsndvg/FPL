...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper1D_I1P_Set
        procedure         ::                 DimensionsWrapper1D_I1P_Get
        generic,   public :: Set          => DimensionsWrapper1D_I1P_Set
        generic,   public :: Get          => DimensionsWrapper1D_I1P_Get
