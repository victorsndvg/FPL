...
private
    ...
    private
        ...
        procedure, public :: toString       => DimensionsWrapper4D_I1P_toString
...
contains
    ...
    function DimensionsWrapper4D_I1P_toString(this) result(String) 
    !-----------------------------------------------------------------
            ...
            do idx4=1, size(this%Value,4)
                do idx3=1, size(this%Value,3)
                    do idx2=1, size(this%Value,2)
                        String = String // trim(str(n=this%Value(:,idx2,idx3,idx4))) // ','
                    enddo
                enddo
            enddo
