...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper4D_I4P_Set
        procedure         ::                 DimensionsWrapper4D_I4P_Get
        generic,   public :: Set          => DimensionsWrapper4D_I4P_Set
        generic,   public :: Get          => DimensionsWrapper4D_I4P_Get
