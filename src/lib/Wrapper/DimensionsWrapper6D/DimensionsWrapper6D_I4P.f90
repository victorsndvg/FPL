...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper6D_I4P_Set
        procedure         ::                 DimensionsWrapper6D_I4P_Get
        generic,   public :: Set          => DimensionsWrapper6D_I4P_Set
        generic,   public :: Get          => DimensionsWrapper6D_I4P_Get
