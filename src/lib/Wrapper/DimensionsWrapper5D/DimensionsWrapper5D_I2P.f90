...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper5D_I2P_Set
        procedure         ::                 DimensionsWrapper5D_I2P_Get
        generic,   public :: Set          => DimensionsWrapper5D_I2P_Set
        generic,   public :: Get          => DimensionsWrapper5D_I2P_Get
