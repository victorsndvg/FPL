...
module DimensionsWrapper5D_I1P
...
private
    ...
    private
        ...
        procedure, public :: toString       => DimensionsWrapper5D_I1P_toString
...
contains
    ...
    function DimensionsWrapper5D_I1P_toString(this) result(String) 
    !-----------------------------------------------------------------
                ...
                do idx4=1, size(this%Value,4)
                    do idx3=1, size(this%Value,3)
                        do idx2=1, size(this%Value,2)
                            String = String // trim(str(n=this%Value(:,idx2,idx3,idx4,idx5))) // ','
                        enddo
                    enddo
                enddo
            enddo
...
end module DimensionsWrapper5D_I1P
