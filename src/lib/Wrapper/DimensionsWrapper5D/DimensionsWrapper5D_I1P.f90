...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper5D_I1P_Set
        procedure         ::                 DimensionsWrapper5D_I1P_Get
        generic,   public :: Set          => DimensionsWrapper5D_I1P_Set
        generic,   public :: Get          => DimensionsWrapper5D_I1P_Get
