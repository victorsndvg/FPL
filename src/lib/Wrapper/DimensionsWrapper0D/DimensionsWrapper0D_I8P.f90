...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper0D_I8P_Set
        procedure         ::                 DimensionsWrapper0D_I8P_Get
        generic,   public :: Set          => DimensionsWrapper0D_I8P_Set
        generic,   public :: Get          => DimensionsWrapper0D_I8P_Get
