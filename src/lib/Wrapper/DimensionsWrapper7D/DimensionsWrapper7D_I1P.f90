...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper7D_I1P_Set
        procedure         ::                 DimensionsWrapper7D_I1P_Get
        generic,   public :: Set          => DimensionsWrapper7D_I1P_Set
        generic,   public :: Get          => DimensionsWrapper7D_I1P_Get
