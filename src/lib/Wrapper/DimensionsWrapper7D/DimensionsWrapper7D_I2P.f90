...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper7D_I2P_Set
        procedure         ::                 DimensionsWrapper7D_I2P_Get
        generic,   public :: Set          => DimensionsWrapper7D_I2P_Set
        generic,   public :: Get          => DimensionsWrapper7D_I2P_Get
