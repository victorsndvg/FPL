...
private
    ...
    contains
    private
        procedure         ::                 DimensionsWrapper2D_I8P_Set
        procedure         ::                 DimensionsWrapper2D_I8P_Get
        generic,   public :: Set          => DimensionsWrapper2D_I8P_Set
        generic,   public :: Get          => DimensionsWrapper2D_I8P_Get
